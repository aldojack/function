...
export default function Feature() {
  return (
    <header className='w-full mt-24 md:mt-4 bg-feature-bg bg-cover min-h-[36.5rem] md:max-h-[45rem] flex items-end justify-center md:justify-start'>
        <button role="button" aria-label="Button to show what's new in the winter collection" className='flex bg-[#282B3A] m-6 text-white items-center w-[21rem] md:w-[28rem] cursor-pointer' tabIndex="0">
